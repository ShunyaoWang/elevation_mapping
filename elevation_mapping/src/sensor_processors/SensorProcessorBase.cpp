		...
		Eigen::VectorXf& variances)
{
  ...
  transformPointCloud(pointCloudInput, pointCloudSensorFrame, sensorFrameId_);//WSHY: transform to sensor frame
  ...
  removePointsOutsideLimits(pointCloudMapFrame, pointClouds);//WSHY: Removes points with z-coordinate above a limit in map frame.
